...
const UpcomingEvents = lazy(() => import('../components/UpcomingEventsV2').then(module => ({ default: module.UpcomingEvents })));
const StrongestHumanSection = lazy(() => import('../components/StrongestHumanV2').then(module => ({ default: module.StrongestHumanSection })));
const UniversitySection = lazy(() => import('../components/UniversitySectionV2').then(module => ({ default: module.UniversitySection })));
const CoachesSection = lazy(() => import('../components/coachesV2').then(module => ({ default: module.CoachesSection })));
const Shop = lazy(() => import('../components/shopV2').then(module => ({ default: module.Shop })));
const VisionSection = lazy(() => import('../components/VisionSectionV2').then(module => ({ default: module.VisionSection })));
const GovernanceSection = lazy(() => import('../components/GovernanceSectionV2').then(module => ({ default: module.GovernanceSection })));
const InaugurationCountdown = lazy(() => import('../components/InaugurationCountdownV2').then(module => ({ default: module.InaugurationCountdown })));
const ContactFooter = lazy(() => import('../components/ContactFooterV2').then(module => ({ default: module.ContactFooter })));
